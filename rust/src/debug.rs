...
impl DisassembleInstruction for u8 {
    fn bytecode_name(&self) -> String {
        match *self {
            ...
            DEFINE_GLOBAL => String::from("OP_DEFINEGLOBAL"),
            DIVIDE => String::from("OP_DIVIDE"),
            EQUAL => String::from("OP_EQUAL"),
            GET_GLOBAL => String::from("OP_GETGLOBAL"),
            GET_LOCAL => String::from("OP_GETLOCAL"),
            GREATER => String::from("OP_GREATER"),
            GREATER_EQUAL => String::from("OP_GREATEREQUAL"),
            ...
            SET_GLOBAL => String::from("OP_SETGLOBAL"),
            SET_LOCAL => String::from("OP_SETLOCAL"),
